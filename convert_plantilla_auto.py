...
def convert_to_rgb565_c(img_path, var_name, out_path):
    ...
    # Force resize to 1280x800 for full screen
...
convert_to_rgb565_c("Imagenes/Plantilla_01.png", "img_plantilla_01", "main/ui/plantilla_01.c")
# I'll keep the idle one from before since he only asked for the first one for now
# or should I convert it too to be sure?
# he said "tomar de fondo para la primera Plantilla_01.png"
print("Conversion complete: main/ui/plantilla_01.c created")
