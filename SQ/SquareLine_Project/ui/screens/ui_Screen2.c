...
lv_obj_t *ui_Screen2 = NULL;lv_obj_t *ui_Label2 = NULL;lv_obj_t *ui_Label3 = NULL;lv_obj_t *ui_Label4 = NULL;lv_obj_t *ui_Button1 = NULL;lv_obj_t *ui_Label5 = NULL;lv_obj_t *ui_Label6 = NULL;lv_obj_t *ui_Label7 = NULL;
// event funtions
...
lv_obj_set_style_bg_image_src( ui_Screen2, &ui_img_espera_png, LV_PART_MAIN | LV_STATE_DEFAULT );
...
lv_obj_set_style_text_color(ui_Label2, lv_color_hex(0x20406A), LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_text_opa(ui_Label2, 255, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_text_font(ui_Label2, &ui_font_Montserrat160, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_text_color(ui_Label3, lv_color_hex(0x020202), LV_PART_MAIN | LV_STATE_DEFAULT );
...
lv_obj_set_style_bg_image_src( ui_Button1, &ui_img_gear_8248448_png, LV_PART_MAIN | LV_STATE_DEFAULT );
