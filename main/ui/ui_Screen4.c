...
void ui_Screen4_screen_init(void) {
  ...
  if (lv_slider_get_mode(ui_Slider1) == LV_SLIDER_MODE_RANGE)
    lv_slider_set_start_value(ui_Slider1, 0, LV_ANIM_OFF);
  ...
  lv_obj_set_style_bg_color(ui_Slider1, lv_color_hex(0xB3B1B1),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_Slider1, 255, LV_PART_MAIN | LV_STATE_DEFAULT);

  lv_obj_set_style_blend_mode(ui_Slider1, LV_BLEND_MODE_ADDITIVE,
  ...
  lv_obj_set_style_text_color(ui_Label8, lv_color_hex(0x070707),
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_opa(ui_Label8, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_font(ui_Label8, &lv_font_montserrat_48,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_font(ui_Roller1, &lv_font_montserrat_48,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_font(ui_Roller2, &lv_font_montserrat_48,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_font(ui_Roller3, &lv_font_montserrat_48,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_font(ui_Roller4, &lv_font_montserrat_48,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_font(ui_Roller5, &lv_font_montserrat_48,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_color(ui_Label9, lv_color_hex(0x0290FB),
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_opa(ui_Label9, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_font(ui_Label9, &lv_font_montserrat_48,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_font(ui_Label10, &lv_font_montserrat_48,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
